  ...
  return (
    <div>
      <div className="relative py-[3%] px-[10px] border border-none  rounded-[20px] overflow-hidden">
        ...
        <div
          className="h-[500px] bg-cover bg-center brightness-50  rounded-[40px]"
          style={{ backgroundImage: `url(${img4})` }}
        ></div>


        <div className="absolute top-[8%] left-0 right-0 mr-[130px] ml-[10px] w-full h-[500px] bg-black/30"></div>
